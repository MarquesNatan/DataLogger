# 1 "src/board/peripheral-controller/peripheral_controller.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/board/peripheral-controller/peripheral_controller.c" 2

# 1 "src/board/peripheral-controller/peripheral_controller.h" 1
...
# 6 "src/board/peripheral-controller/peripheral_controller.h" 2
...
# 2 "src/board/peripheral-controller/peripheral_controller.c" 2

# 1 "src/board/peripheral-controller/../../pic18f4520/gpio/gpio.h" 1
# 3 "src/board/peripheral-controller/peripheral_controller.c" 2

# 1 "src/board/peripheral-controller/../../board/pinout/pinout.h" 1
# 4 "src/board/peripheral-controller/peripheral_controller.c" 2
...
# 20 "src/board/peripheral-controller/peripheral_controller.c"
    ...
    if(0x00 == 0x00) TRISB = (TRISB & (~(1 << 6))); else TRISB = (TRISB | (1 << 6));;
    if(0x00 == 0x00) TRISB = (TRISB & (~(1 << 7))); else TRISB = (TRISB | (1 << 7));;

    if(0x00 == 0x00) TRISB = (TRISB & (~(1 << 3))); else TRISB = (TRISB | (1 << 3));;
    if(0x00 == 0x00) TRISB = (TRISB & (~(1 << 2))); else TRISB = (TRISB | (1 << 2));;


    if(0x00 == 0x00) TRISC = (TRISC & (~( 1 << 6))); else TRISC = (TRISC | ( 1 << 6));;
    if(0x00 == 0x00) TRISC = (TRISC & (~( 1 << 7 ))); else TRISC = (TRISC | ( 1 << 7 ));;
